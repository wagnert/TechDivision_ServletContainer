...
/**
 * TechDivision\ServletContainer\Servlets\Legacy\Mage
 *
 * NOTICE OF LICENSE
 *
...
use TechDivision\ServletContainer\Servlets\Legacy\Mage as Mage;
...
class Mage extends PhpServlet
{
     ...
     * @var bool
     */
    public static $_isDownloader = false;
     ...
     * @var bool
     */
    public static $_isDeveloperMode = false;
     ...
     *
     */
    public static $_currentEdition = self::EDITION_COMMUNITY;
    ...
    protected function prepareGlobals(Request $req)
    {
        ...
        if ($this->getServletConfig()
            ->getApplication()
            ->isVhostOf($req->getServerName()) === true) {
            $directoryIndex = $this->getDirectoryIndex();
        } else {
            $directoryToPrepend = DIRECTORY_SEPARATOR . $this->getServletConfig()
                ->getApplication()
    ...
    public function run(Request $req)
    {
        try {
            ...
            class_alias('TechDivision\ServletContainer\Servlets\Legacy\Mage', '\Mage');
